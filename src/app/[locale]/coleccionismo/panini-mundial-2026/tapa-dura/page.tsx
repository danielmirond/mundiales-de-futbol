...
export async function generateMetadata({
  ...
  return pageMetadata({
    ...
    title:
      'Álbum Panini Mundial 2026 tapa dura · Hardcover, pasta dura y edición dorada',
    description:
      'Álbum tapa dura del Mundial 2026: edición coleccionista en pasta dura/hardcover, versión dorada con láminas exclusivas, precio (12-20€), dónde comprar (Panini Store, Amazon, Target, Walmart, Carrefour), tirada limitada, comparativa con la tapa blanda y guía para coleccionistas serios. Hardcover, pasta dura y tapa dorada del Mundial 2026.',
    keywords: [
      'álbum panini mundial 2026 tapa dura',
      'album tapa dura mundial 2026',
      'album panini mundial 2026 tapa dura',
      'album mundial 2026 tapa dura',
      'álbum tapa dura mundial 2026',
      'álbum mundial 2026 tapa dura',
      'album mundial 2026 tapa dura dorado',
      'album panini mundial 2026 tapa dura dorada',
      'album tapa dura mundial 2026 dorado',
      'album mundial 2026 tapa dura dorada',
      'album mundial tapa dorada',
      'album mundial tapa dura dorado',
      'album mundial tapa dura dorada',
      'álbum tapa dura panini mundial 2026',
      'álbum panini mundial 2026 en españa tapa dura',
      'álbum mundial 2026 tapa dura españa',
      'álbum panini tapa dura mundial 2026',
      'panini mundial 2026 hardcover',
      'panini world cup 2026 album hard cover',
      'panini world cup 2026 hardcover',
      'hard cover album world cup 2026',
      'hardcover panini world cup 2026',
      'album pasta dura mundial 2026',
      'album panini mundial 2026 pasta dura',
      'album panini mundial pasta dura',
      'libro del mundial 2026',
      ...
      'álbum panini mundial 2026 dorado',
      'edicion dorada panini 2026',
      'album mundial 2026 panini tapa dorada',
      'album mundial dorado 2026',
      'álbum del mundial 2026 dorado',
    ],
    type: 'article',
  });
}
