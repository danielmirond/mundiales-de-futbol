...
export async function generateMetadata({
  ...
  return pageMetadata({
    ...
    title: 'Álbum dorado Panini Mundial 2026: edición especial oro, lujo y numerada',
    description:
      'Las ediciones especiales del álbum Panini Mundial 2026: oro coleccionista (1.500 unidades en España), lujo numerada, plata y caja premium. Precio, qué incluye cada una y cómo distinguir las verdaderas ediciones limitadas de las copias estándar.',
    keywords: [
      'album dorado mundial 2026',
      'album mundial 2026 edicion especial',
      'album panini mundial 2026 edicion especial',
