...
export const AMAZON_PRODUCTS: AmazonProduct[] = [
  ...
  {
    id: 71,
    title: 'Panini FIFA World Cup 2026 álbum oficial de cromos (tapa blanda)',
    asin: 'B0GNDPJ2JB',
    verified: true,
    category: 'juguetes',
    commission: 7,
    priceMin: 4,
    priceMax: 8,
    uses: 'El álbum oficial donde pegar los cromos del Mundial 2026. Punto de partida de la colección, barato y con gran intención de compra.',
    worldCupYear: 2026,
    featured: true,
  },
  {
    id: 72,
    title: 'Panini FIFA World Cup 2026 Ecoblister 8 sobres (56 cromos)',
    asin: 'B0G5Q7491B',
    verified: true,
    category: 'juguetes',
    commission: 7,
    priceMin: 11,
    priceMax: 14,
    uses: 'Blister de 8 sobres con 56 cromos del Mundial 2026. Formato intermedio entre el sobre suelto y la caja, ideal para avanzar el álbum.',
    worldCupYear: 2026,
  },
  {
    id: 73,
    title: 'Panini FIFA World Cup 2026 Mega Multiset cromos',
    asin: 'B0G5Q9KCP2',
    verified: true,
    category: 'juguetes',
    commission: 7,
    priceMin: 30,
    priceMax: 40,
    uses: 'Pack grande con álbum y varios sobres del Mundial 2026 en un solo set. Buen punto de partida para coleccionistas que empiezan fuerte.',
    worldCupYear: 2026,
  },
  {
    id: 74,
    title: 'Panini FIFA World Cup 2026 Adrenalyn XL Trading Cards (Fatpack)',
    asin: 'B0GN9KM2ZX',
    verified: true,
    category: 'juguetes',
    commission: 7,
    priceMin: 80,
    priceMax: 95,
    uses: 'Las cartas coleccionables Adrenalyn XL del Mundial 2026 (juego de cartas, distinto de los cromos del álbum). Fatpack con gran cantidad de cartas.',
    worldCupYear: 2026,
  },
  {
    id: 75,
