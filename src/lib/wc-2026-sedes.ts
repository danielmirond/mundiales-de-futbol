...
export const SEDES_2026: SedeCity[] = [
  // ─── USA ──────────────────────────────────────────────────────
  {
    ...
    heroEditorial:
      'Atlanta es la sede más conectada del sur de Estados Unidos. Su aeropuerto Hartsfield-Jackson lleva años siendo el más transitado del mundo, lo que la convierte en la entrada natural para fans europeos y latinoamericanos. Dentro de la ciudad, el Mercedes-Benz Stadium se sienta a pocos minutos del centro y conecta directamente por metro (línea MARTA, parada GWCC/CNN Center). Para España, además, es la sede del partido inaugural el 13 de junio: vs Cabo Verde a las 21:00 hora peninsular. La tarde del partido la avenida Centennial se convierte en una fan zone informal alrededor del Coca-Cola Museum y el Centennial Park.',
    whyHere:
  ...
  },
  {
    ...
    heroEditorial:
      'Boston entra en el Mundial 2026 con una asimetría curiosa: la ciudad histórica está en Boston, pero el estadio está en Foxborough, a 47 km al sur. La hora de viaje en coche o en autobús lanzadera es parte del ritual del fan americano (Patriots y Revolution juegan ahí desde 2002). El partido tipo del Mundial en Gillette Stadium tiene un componente diferente al de las otras sedes: la mayoría del público llega en coche, lo que cambia los tiempos de entrada y salida y reduce la fan zone urbana clásica. Boston Common y Fenway Park siguen siendo el corazón cultural-deportivo donde verás aficiones internacionales reunidas las horas previas.',
    whyHere:
      'Boston es la sede más rica culturalmente del Mundial. Camina por el Freedom Trail (sendero rojo de 4 km que une 16 sitios históricos), pasea por Harvard Yard (Cambridge), come en el North End italiano, y luego viajas al partido. Si te interesa el deporte y la historia americana, ninguna otra sede mezcla ambos como Boston.',
    aboutStadium:
  ...
  },
  {
    ...
    whyHere:
      'Si quieres una sede USA donde el español sea de uso diario y el ambiente festivo se note desde el aterrizaje, Houston es la opción. La NASA está aquí (Space Center Houston), la cocina tex-mex original también, y los precios son más bajos que en NY/LA/Miami.',
    aboutStadium:
  ...
  },
  {
    ...
    whyHere:
      'Kansas City es la sede menos turística del Mundial, lo que la hace la más auténticamente americana. Si quieres ver un partido sin las masas de fans europeos/latinos que dominarán LA, Miami o NY, ésta es tu opción. Comida brutal, precios accesibles, ambiente NFL-puro.',
    aboutStadium:
  ...
  },
  {
    ...
    whyHere:
      'Los Ángeles ofrece el package completo: estadio espectacular, ciudad mítica, playa, Hollywood, y comunidad latina enorme. La oferta gastronómica latinoamericana es la mejor de USA. Pero también es la sede más cara: hoteles, comidas, taxis, todo sube en junio-julio.',
    aboutStadium:
  ...
  },
  {
    ...
    whyHere:
      'Nueva York es la sede definitiva: no solo final, sino la ciudad icono del mundo. Si solo puedes permitirte un viaje al Mundial, considera apuntar al MetLife, la final es siempre la final, y la ciudad alrededor es Nueva York. El package es caro (350-700 $/noche en Manhattan en julio) pero único.',
    aboutStadium:
  ...
  },
  {
    ...
    whyHere:
      'La Bay Area combina lo mejor: SF es una de las ciudades más bonitas de USA, el Silicon Valley es un fenómeno cultural en sí mismo, y Napa Valley está a 90 minutos al norte para escapadas de vino. Si te gusta la tecnología o el vino, esta sede es la más rica más allá del partido.',
    aboutStadium:
  ...
  // ─── MÉXICO ──────────────────────────────────────────────────
  {
    ...
    heroEditorial:
      'El Estadio Azteca acoge el partido inaugural del Mundial 2026 el 11 de junio a las 13:00 hora local CST: México vs Sudáfrica. Será la tercera vez que el Azteca abre un Mundial, antes lo hizo en 1970 (México vs URSS, 0-0) y 1986 (Italia vs Bulgaria, 1-1). Ningún otro estadio del mundo ha acogido tres Mundiales. Para los aficionados es probablemente el único partido del torneo donde se mezclan tres dimensiones: la histórica (la cancha de la Mano de Dios, del Brasil eterno de 1970, del Gol del Siglo), la deportiva (México como anfitrión casi favorito por ambiente) y la urbana (Ciudad de México, una de las metrópolis más vibrantes del mundo).',
    whyHere:
  ...
  },
  {
    ...
    whyHere:
      'Vancouver es la sede más bonita del Mundial 2026, naturaleza extrema en pleno centro urbano. Si te interesan paisajes, naturaleza y combinar Mundial con escapada a Whistler o Alaska, ésta es tu base. Cluster perfecto con Seattle (160 km al sur, en USA).',
    aboutStadium:
